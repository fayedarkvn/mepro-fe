                  ...
                  <div className="max-w-sm mx-auto">
                    ...
                    <div className="flex justify-center gap-4 mb-3">
                      <Button onClick={googleLogin} variant="outline" size="icon" className="rounded-full">
                        <svg width="80px" height="80px" viewBox="-0.5 0 48 48" version="1.1"
                      ...
                      <Button onClick={googleLogin} variant="outline" size="icon" className="rounded-full">
                        <svg width="100px" height="100px" viewBox="0 -0.5 48 48" version="1.1"
                             xmlns="http://www.w3.org/2000/svg">
                          <g id="Icons" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <Input onChange={e => setValueMail(e.target.value)} type="email" name="username" value={valueMail}
                             placeholder="Email"/>
